...
export const TelegramMobileLoginButton = ({ onInitRequest, onStateRequest, appId, onLogin, }) => {
    ...
    return !data ? (_jsxs(LinkButton, { disabled: !data, children: [_jsx(LoaderIcon, {}), "Login with Telegram"] })) : (_jsxs(LinkButton, { onClick: handleClick, href: `tg://resolve?domain=${encodeURIComponent(data.botName)}&start=tga_m_${appId}_${data.requestId}`, target: "_blank", children: [_jsx(TelegramIcon, {}), "Login with Telegram"] }));
};
//# sourceMappingURL=TelegramMobileLoginButton.js.map